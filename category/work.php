<?php
	require '../inc/db.php';
	$posts = R::findAll('posts', 'post_status = ? AND post_category = ? ORDER BY id DESC', ['Одобрено', 'Рабочие вакансии']);
?>
<!DOCTYPE html>
<html>
<head>
	<title>Рабочие вакансии</title>
                            ...
                            <ul class="list-unstyled product-sidebar__links">
                                <li class="mb-3">
                                	<div style="width: 100%; height: 240px; border: 1px solid dodgerblue;">
                                		<img class="ad-img" srf="http://aist.site/images/assets/ad-banner-111.png">	
                                	</div>
                                </li>
                                <li class="mb-3">
                                	<div style="width: 100%; height: 240px; border: 1px solid dodgerblue;">
                                		<img class="ad-img" srf="http://aist.site/images/assets/banner-staty.jpg">	
                                	</div>
                                </li>
                                <li class="mb-3">
                                	<div style="width: 100%; height: 240px; border: 1px solid dodgerblue;">
